function config = inactivate_epochs( epoch_names, config )

%   INACTIVATE_EPOCHS -- Update the epochs that won't be loaded by
%     get_signals().
%
%     IN:
...
for i = 1:numel(epoch_names)
  ...
  config.SIGNALS.EPOCHS.(current).active = false;
end