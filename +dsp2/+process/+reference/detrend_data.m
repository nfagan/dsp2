function data = detrend_data(data)

%   DETREND -- Detrend by ensemble- and temporal- re-referencing.
%
%     obj = dsp2.process.reference.detrend_data ( data ); performs the 
%     following pre-processing operations on the 2-d `data.`
%
...
dsp2.util.assertions.assert__isa( data, 'double', 'the data' );
